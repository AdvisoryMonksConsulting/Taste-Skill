  ...
  <main className="mx-auto max-w-3xl px-6 py-16">
    ...
    <div className="mt-12 rounded-2xl p-8 text-center" style={{ backgroundColor: C.blue }}>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        <Link href="/demos/strive" className="rounded-full border px-7 py-3 text-sm font-bold uppercase tracking-[0.15em]" style={{ borderColor: C.teal, color: C.teal }}>Take the X-Ray</Link>
        <Link href="/demos/strive/apply" className="rounded-full px-7 py-3 text-sm font-bold uppercase tracking-[0.15em] text-white" style={{ backgroundColor: C.rasp }}>Apply now</Link>
      </div>
    </div>
  </main>
);
