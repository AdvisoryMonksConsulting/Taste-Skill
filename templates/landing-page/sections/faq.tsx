  ...
  return (
    <section id="faq" className="bg-white py-24">
      ...
      <div className="mx-auto max-w-3xl px-6">
        <h2 className="text-center text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl">{faq.heading}</h2>
        <div className="mt-12 divide-y divide-neutral-200 border-y border-neutral-200">
          {faq.items.map((i) => (
            <details key={i.q} className="group py-5">
              <summary className="flex cursor-pointer list-none items-center justify-between text-left font-medium text-neutral-900">
                {i.q}
