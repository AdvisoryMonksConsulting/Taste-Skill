 ...
 * hover lift/press (t-lift/t-press), driven by the semantic motion tokens in
 * globals.css and an IntersectionObserver below. Respects prefers-reduced-motion.
 *
...
/** Inline helper for stagger index (typed-safe custom property). */
...
export const InvestHerDemo: FC = () => {
  ...
  return (
    <main ref={scope} className="font-sans" style={{ backgroundColor: c.cream, color: c.ink }}>
      {/* nav */}
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        ...
        <a href="#join" className="t-press rounded-full px-5 py-2.5 text-sm font-medium" style={onPlum}>Join free</a>
      </nav>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:py-28">
          <div className="t-reveal text-white">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a href="#join" className="t-press rounded-full px-8 py-4 text-center text-base font-semibold shadow-lg" style={onRose}>
      ...
      <section id="pillars" className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {pillars.map((p, i) => (
            <div key={p.k} className="t-reveal t-lift rounded-2xl border bg-white p-8" style={{ borderColor: c.line, ...stagger(i) }}>
      ...
      <section id="grow" className="py-20" style={{ backgroundColor: "#fff" }}>
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {ladder.map((l, i) => (
              <div key={l.t} className="t-reveal t-lift flex flex-col rounded-2xl p-7" style={{ backgroundColor: c.cream, ...stagger(i) }}>
      ...
      <section id="podcast" className="mx-auto max-w-6xl px-6 py-20">
        <div className="t-reveal grid items-center gap-10 rounded-3xl p-10 md:grid-cols-2" style={{ backgroundColor: c.plumDark, color: "#fff" }}>
          <div>
            ...
            <a href="#" className="t-press mt-7 inline-block rounded-full px-7 py-3 text-sm font-semibold" style={onRose}>Listen now</a>
          </div>
          <div className="space-y-3">
            {["Scaling to 100 doors as a mom of three", "The systems that bought back my time", "Self-care isn’t soft — it’s strategy"].map((t) => (
              <div key={t} className="t-lift flex items-center gap-4 rounded-xl bg-white/10 p-4">
      ...
      <section className="py-20" style={{ backgroundColor: "#fff" }}>
        <div className="mx-auto grid max-w-5xl items-center gap-10 px-6 md:grid-cols-[0.8fr_1.2fr]">
          <div className="t-reveal t-scale-in aspect-square rounded-3xl" style={{ background: `linear-gradient(135deg, ${c.rose}, ${c.plum})` }} />
          <div className="t-reveal" style={stagger(1)}>
            ...
            <a href="#join" className="t-press mt-7 inline-block rounded-full px-7 py-3 text-sm font-semibold" style={onPlum}>Join us free</a>
          </div>
        </div>
      </section>
      ...
      <section id="con" className="mx-auto max-w-6xl px-6 py-20">
        <div className="t-reveal t-scale-in rounded-3xl border-2 border-dashed p-10 text-center" style={{ borderColor: c.gold }}>
          ...
          <a href="#" className="t-press mt-7 inline-block rounded-full px-8 py-3.5 text-sm font-semibold" style={onRose}>See conference details</a>
        </div>
      </section>
      ...
      <section id="join" className="py-24 text-center text-white" style={{ background: `linear-gradient(160deg, ${c.plum}, ${c.plumDark})` }}>
        <div className="t-reveal mx-auto max-w-2xl px-6">
          ...
          <a href="#" className="t-press mt-9 inline-block rounded-full px-10 py-4 text-base font-semibold shadow-lg" style={onRose}>
            Join the free community →
          </a>
