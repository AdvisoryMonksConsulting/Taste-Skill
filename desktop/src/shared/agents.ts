...
// Kept in sync with the web app's src/lib/research/agents.ts (prompts are
// identical; the desktop copy drops web-specific styling fields).

import type { AgentId } from "./types";

export interface AgentDef {
  id: AgentId;
  /** Short label shown in the UI and report exports. */
  title: string;
