  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { h: "2. Payment", p: "Projects require a 50% deposit to reserve a slot and begin work, with the remaining 50% due on delivery. Larger projects may be split into milestones (typically 40% to start, 30% at design sign-off, 30% on delivery). Retainers are billed monthly in advance via auto-pay (Razorpay subscription). Final deliverables, source code, and deploy access are released only once the final payment for that project has cleared. All prices are exclusive of applicable taxes. Payments are accepted via Razorpay (card), Wise, Payoneer, or PayPal." },
